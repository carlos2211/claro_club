...
if ($id != ""){
    ...
    if ($detalle_convenio['mensaje'] != "error id") { ?>
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html lang="es-CL">
        <head>
            <title>Claro Chile</title>
            <!-- Meta -->
            ...
            function valida_cli(){
                ...
                if ($("#celular").val()!="" && paso){
                    ...
                    if (($("#celular").val().length > 9 || $("#celular").val().length < 9)  && paso){
                        paso=false;
                        $("#f_celular").addClass("error");
                        $("#error_celular").html("Ingresa un número válido, asociado a Claro.");
                        $("#enviar").prop( "disabled", false );
                        $("#celular").focus();
                    }
                }
        ...
        <body>
            <div class="container">
                <h1><?php echo $detalle_convenio['nombre'];?></h1>
                <!---->
                <ul class="links">
                ...
                <div class="beneficio">
                    <ul class="menu">
                        ...
                        <!--<li class="obtener"><a href="#obtener">Obtener</a></li>-->
                        <li class="activo detalles"><a href="#detalles">Detalles</a></li>
                    ...
                    <?php if ($id == 1581){ ?>
                        ...
                        <div class="botonera" id="obtener">
                            <a class="b1" href="descuento_detalle.php?id=1710">Cine 2D</a>
                            <a class="b2" href="descuento_detalle.php?id=1711">Cine 3D</a>
                            <a class="b3" href="descuento_detalle.php?id=1712">Confiteria</a>
                        ...
                        <div id="obtener">
                            ...
                            <form name="form1" id="form1" action="descuento_detalle_.php" method="post">
                                <fieldset id="f_rut" name="f_rut">
                                    <label>Si eres cliente HOGAR ingresa tu rut para validar.</label>
                                ...
                                <fieldset id="f_celular" name="f_celular">
                                    <label>Si eres cliente MÓVIL ingresa tu celular para validar.</label>
                            ...
                            <div class="sms">
                                <p><?php echo $detalle_convenio['mecanica'] ?> <h2>y recibirás el código del beneficio</h2></p>
                            </div>
                        </div>
                        <?php } ?>
                        <!---->
                        <div id="detalles">
                            <ul class="descuento">
                                <li>
                                    <b><?php echo $detalle_convenio['nombre']?></b>
                                    <a href="<?php echo $detalle_convenio['url'] ?>" target="_blank"><?php echo $detalle_convenio['url'] ?></a>
                                    <?php
                                    if($detalle_convenio['url'] != ""){
                                        echo '<br>';
                                    }
                                    $pos = strpos($detalle_convenio['detalle'], '%');
                                    if ($pos === false) {
                                        echo '<strong>'.$detalle_convenio['descuento'].'</strong>';
                                        echo '<br><br>';
                                        echo $detalle_convenio['detalle'];
                                    }else{ ?>
                                        <p style="margin-left: 0px"><?php echo (str_replace("|","</br>",$detalle_convenio['detalle']))?></p>
                                    <?php }
                                    ?>
                                </li>
                            </ul>
                            <ul class="legales">
                                ...
                                /*FIN FORMATEAR FECHA*/
                                ?>
                                <li>Vigencia hasta el  <?php echo $fecha_escrita?>.</li>
                                <li><?php echo $detalle_convenio['importante']?></li>
                            </ul>
                        </div>
                        <!---->
