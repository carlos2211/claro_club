...
$fecha_hasta = $objFecha->to_sql($_GET["fecha_hasta"]);
    ...
    $nombre_planilla="Reporte Convenios";
/*Fin Nombre de la planilla excel*/

/*SQL para obtener datos del reporte*/
    
$sql="SELECT id_convenio as ID_Convenio,nombre_convenio as Nombre_Convenio, COUNT(id) as Numero_Solicitudes FROM uso_convenio WHERE (fecha >='".$fecha_desde." 00:00:00' and fecha <= '".$fecha_hasta." 23:59:59') GROUP BY id_convenio,nombre_convenio";
